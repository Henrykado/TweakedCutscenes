...
void ev0087_k_chaos2(int state)
{
	...
	case 1:
		...
		EV_SetPos(W_EME, 4.9000001f, 14.5f, -57.5f);
		EV_SetAng(W_EME, -0x1000, 0, 0);
		EV_Wait(18);
		...
		EV_ClrFace(player);
		EV_Wait(10);
		EV_LookPoint(player, -18.0f, 19.0f, -63.0f);
