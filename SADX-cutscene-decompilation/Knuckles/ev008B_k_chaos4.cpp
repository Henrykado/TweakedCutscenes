...
void ev008B_k_chaos4(int state)
{
	...
	case 1:
		...
		ToHumanChaos2();
		EV_Wait(20);
		EV_LookPoint(sonic, 26.83f, 76.800003f, 159.98f);
		...
		EV_Wait(45);
		EV_LookPoint(tails, 26.83f, 79.800003f, 159.98f);
		...
		EV_Wait(10);
		EV_SerifPlay(1086);
		EV_Msg(msgTbl_ev008B[TextLanguage][14]); //"\aNow look what he is!"
		EV_SerifWait();
		EV_Wait(12);
		EV_SerifPlay(1087);
