...
void ev00D2_b_car(int state)
{
	...
	case 1:
		...
		EV_CameraAng(0, 0, 0xFC19, 0x60C4, 0);
		EV_MsgClose();
		//EV_CameraPos(0, 40, 469.22f, 15.12f, 882.45001f);
		EV_CameraAng(0, 40, 0xFC19, 0xB6C4, 0);
		EV_Wait(20);
		stopObject(Frog);
		EV_FreeObject(&Frog);
		EV_Wait(15);
		...
		EV_Wait(5);
		EV_MovePoint2(player, 369.59f, 0.0099999998f, 1003.5f, 0.5f, 0.069999999f);
		EV_Wait(80);
		EV_MoveFree(player);
		EV_SetPos(player, 369.59f, 0.0099999998f, 1003.5f);
