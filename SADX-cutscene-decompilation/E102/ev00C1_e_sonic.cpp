...
void ev00C1_e_sonic(int state)
{
	...
	case 1:
		...
		EV_LookObject(tails, player, 0.0f, 9.0f, 0.0f);
		...
		EV_Wait(5);
		EV_LookFree(tails);
		EV_LookObject(tails, player, 0.0f, 12.0f, 0.0f);
		EV_LookFree(sonic);
		...
		EV_Wait(50);
		EV_MsgClose();
		eggmoble_turn(0, -0x4000, 0, 20, 0);
		EV_Wait(24);
		eggmoble_moveandturn(-74.300003f, 1570.5f, 3240.8999f, 0, -0x4000, 0, 35, 0);
		EV_Wait(40);
		ChgEggMobleSMod(1);
		EV_Wait(1);
		eggmoble_move_normal(-186.8f, 1605.9f, 2450.3999f, 80);
		EV_Wait(40);
		EV_MsgClose();
		EV_Wait(10);
		break;
