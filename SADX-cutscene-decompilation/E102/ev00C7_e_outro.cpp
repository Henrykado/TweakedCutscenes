...
void ev00C7_e_outro(int state)
{
	...
	case 1:
		...
		EV_SetAction(E101KAI, &action_saigo_e101kai_e101kai, &texlist_ev_e101kai, 1.3f, 1, 0);
		EV_Wait(20);
		...
		moveObject(bird1, -91.099998f, 769.70001f, -300.48001f, -39.099998f, 780.84003f, -263.0f, 38);
		EV_Wait(40);
		moveObject(bird1, -39.099998f, 780.84003f, -263.0f, -39.099998f, 800.84003f, -280.0f, 42);
		EV_Wait(45);
