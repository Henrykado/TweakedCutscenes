...
void ev0072_a_outro(int state)
{
	...
	case 1:
		...
		EV_SetPos(obj_wing2, -134.5f, 746.2f, -376.5f);
		...
		EV_Wait(70);
		WHITE = COverlayCreate(0.02f, 0.001f, 1.0f, 1.0f, 1.0f);
