...
void ev0071_a_amygetangry(int state)
{
	...
	case 1:
		...
		EV_SetAction(player, &action_a_a0011_amy, &AMY_TEXLIST, 1.2f, 1, 0);
		EV_Wait(101);
		zero = EV_GetPlayer(2);
		...
		EV_SetAng(player, 0, 0x8000, 0);
		EV_MovePoint2(player, -1.5f, 747.20001f, -287.89999f, 0.79999998f, 0.059999999f);
		...
		//EV_SetAction(obj_wing2, &action_w_w0123_wing, &VER2_WING_TEXLIST, 1.0f, 1, 0);
		EV_Wait(80);
