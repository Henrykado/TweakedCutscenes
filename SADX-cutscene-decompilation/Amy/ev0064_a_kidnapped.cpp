...
void ev0064_a_kidnapped(int state)
{
	...
	case 1:
		...
		EV_Wait(15);
		EV_CameraPos(0, 32, 332.5f, 14.0f, 1349.1f);
		EV_CameraAng(0, 32, 0x49C, 0x7F86, 0);
		EV_Wait(30);
		EV_ClrFace(player);
		EV_RemovePlayer(3);
		...
		EV_SerifPlay(883);
		EV_Wait(60);
		moveObjectAngle2(egg_amy, 71.5f, 21.5f, 1461.4f, 41.5f, 35.799999f, 1408.4f, 0, 0xD000, 0, 0, 0xD000, 0, 75);
		EV_Wait(75);
		stopObjectAll();
		break;
	case 2:
