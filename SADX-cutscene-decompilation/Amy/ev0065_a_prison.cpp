...
void ev0065_a_prison(int state)
{
	...
	case 1:
		...
		EV_MovePoint2(e102, 135.0f, 0.0f, 16.0f, 0.75f, 0.059999999f);
		EV_Wait(40);
		EV_MovePoint2(e102, -40.0f, 0.0f, 16.0f, 0.75f, 0.059999999f);
		...
		EV_Wait(90);
		EV_SerifPlay(887);
		EV_MsgW(70, msgTbl_ev0065[TextLanguage][2]); //"\aHand me the bird."
		EV_MsgClose();
		EV_CameraPerspective(0, 1, 0xE39);
		EV_CameraPos(0, 0, -108.74f, 18.299999f, 11.14f);
		EV_CameraAng(0, 0, 0xF3EC, 0xF4F3, 0);
		EV_SetAction(player, &action_a_a0117_amy, &AMY_TEXLIST, 0.9f, 0, 0);
		EV_SetAction(obj_ver1_wing, &action_w_w0117_wing, &VER1_WING_TEXLIST, 0.8f, 0, 0);
		EV_SetAction(player, &action_a_a0118_amy, &AMY_TEXLIST, 0.9f, 1, 0);
		EV_SetAction(obj_ver1_wing, &action_w_w0118_wing, &VER1_WING_TEXLIST, 0.8f, 1, 0);
		EV_ClrFace(player);
		EV_SetFace(player, "F");
		EV_SerifPlay(888);
		...
		EV_MsgClose();
		EV_CameraPos(0, 15, -119.13f, 1.76f, -57.380001f);
		EV_Wait(15);
		...
		EV_SerifPlay(908);
		EV_Msg(msgTbl_ev0065[TextLanguage][23]); //"\aIt's dangerous here."
		EV_SerifWait();
		EV_Wait(10);
		...
		EV_Wait(15);
		EV_SerifPlay(909);
		EV_Msg(msgTbl_ev0065[TextLanguage][24]); //"\aHurry.  We'll be at \nthe Mystic Ruin"...
		EV_SerifWait();
		EV_Wait(5);
		EV_MsgClose();
		EV_CameraPerspective(0, 1, 0x1C72);
