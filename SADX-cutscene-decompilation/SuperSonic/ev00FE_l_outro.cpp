...
void ev00FE_l_outro(int state)
{
	...
	case 1:
		...
		EV_SerifPlay(1508);
		EV_Msg(msgTbl_ev00FE[TextLanguage][3]); //"\aThey stayed alive for generations\nan"...
		EV_SerifWait();
		EV_MsgClose();
		EV_Wait(20);
		...
		EV_Wait(35);
		ChgEggMobleSMod(1);
		eggmoble_move_rapid(1386.8f, 600.0f, -2868.25f, 300);
